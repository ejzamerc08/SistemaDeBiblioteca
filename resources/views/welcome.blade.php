...
<center><h1>Administrador</h1></center>
    ...
    <div>
        @if (Route::has('login'))
            <div>
                @auth
                <center><a href="{{ url('dashboard') }}" class="btn btn-primary">Inicio</a></center>
                <br>
                <br>
                <br>
                @else
    ...
    <div class="container-fluid">
        <div class="row p-5 bg-dark text-white">
            <div class="col-xs-12 col-md-6 col-lg-3">
                <p class="h2">I U Digital</p>
            </div>
            <div class="col-xs-12 col-md-6 col-lg-3">
                <p class="h5">Contacto</p>
                <div class="mb-2 text-secondary">
                    Teléfono: 209 56 89 <br>
                    Correo: biblioteca@iudigital.edu.co             
                </div>
            </div>
            <div class="col-xs-12 col-md-6 col-lg-3">
                <p class="h5">Dirección</p>
                <div class="mb-2 text-secondary">
                    Calle 34 b #34 a 55 <br>
                     Medellín -  Colombia
                </div>
            </div>
            <div class="col-xs-12 col-md-6 col-lg-3">
                <p class="h5">Siguenos en:</p>
                <div>
